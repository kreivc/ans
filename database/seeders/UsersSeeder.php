...
class UsersSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('users')->insert([
            ...
            ['name' => 'Raymon', 'email' => 'raymon@gmail.com', 'password' => bcrypt('pass123'), 'email_verified_at' => null, 'photo_profile' => 'https://avatars.dicebear.com/api/initials/:R.svg', 'remember_token' => null]
        ]);
    }
}
